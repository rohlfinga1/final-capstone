...
//                 :class="{ 'card-content-correct': card.correct,
//                 'card-content-wrong': card.wrong}"
...
//     },
//     created(){
//         this.getDeckForSession(this.deck.deckId);
//         this.getCardsForSession(this.deck.deckId);
//         // need to mutate this, not set it
...
//             {
//                 this.index = this.cards.indexOf(this.card);
//                 this.card = this.cards[this.index - 1];
//                 this.flipped = false;
//             }
//         },
//         goNext() {
//             if (this.card != this.cards[this.cards.length - 1])
//             {
//                 this.index = this.cards.indexOf(this.card);
//                 this.card = this.cards[this.index + 1];
//                 this.flipped = false;
...
//         },
//         markCorrect(card) {
//             this.$store.commit('MARK_CORRECT', card);
//             this.$store.commit('MARK_SCORED', card);
//         },
//         markWrong() {
//             this.card.correct = false;
//             this.card.wrong = true;
//             this.card.scored = true;
//         },
//         getCardsForSession(deckId) {
...
//             })
//         },
//         getDeckForSession(deckId) {
//             DeckService.getDeck(deckId).then((response) => {
